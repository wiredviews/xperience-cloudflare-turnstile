...
{
    public interface ITurnstileSettingsInstaller
    {
        void Install();
    }
    ...
    /// </summary>
    internal class TurnstileSettingsInstaller : ITurnstileSettingsInstaller
    {
        ...
        public TurnstileSettingsInstaller(IEventLogService log,
        ...
        public void Install()
        {
            ...
            {
                log.LogException(nameof(TurnstileSettingsInstaller), "INSTALLATION_ERROR", ex);
            }
        }
        ...
        private void InstallSettings(ResourceInfo resourceInfo)
        {
            ...
            })
            {
                ...
                if (category is null)
                {
                    log.LogError(nameof(TurnstileSettingsInstaller), "INSTALLATION_ERROR", $"Could not find Settings Category {ResourceConstants.SettingsCategoryName}");

                    return;
                }

                string publicKeyText = @"The public site API key for the site where you want to use Cloudflare Turnstile.<br /><br /> You can get your API keys at <a href=""https://dash.cloudflare.com/"">https://dash.cloudflare.com/</a>.";
                string secretKeyText = @"The secret API key for the site where you want to use Cloudflare Turnstile.<br /><br /> You can get your API keys at <a href=""https://dash.cloudflare.com/"">https://dash.cloudflare.com/</a>.";

                var keys = new SettingsKeyInfo[]
                {
                    new SettingsKeyInfo
                    {
                        KeyName = "CMSTurnstilePublicKey",
                        KeyDisplayName = "Cloudflare Turnstile Public Key",
                        KeyType = "string",
                    ...
                    new SettingsKeyInfo
                    {
                        KeyName = "CMSTurnstileSecretKey",
                        KeyDisplayName = "Cloudflare Turnstile Secret Key",
                        KeyType = "string",
                        KeyCategoryID = category.CategoryID,
                        KeyDefaultValue = "",
        ...
        private void LogInformation(string eventCode, string eventMessage) => log.LogEvent(EventTypeEnum.Information,
                                      nameof(TurnstileSettingsInstaller),
                                      eventCode,
                                      eventMessage);
    }
    ...
    {
        public const string ResourceName = "XperienceCommunity.Cloudflare.Turnstile";
        public const string ResourceDisplayName = "XperienceCommunity Turnstile";
        public const string ResourceDescription = "XperienceCommunity settings for Cloudflare Turnstile Form Component";
